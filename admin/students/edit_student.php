...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysqli_query($conn, $query_update)) {
        ...
        echo "<a href='../manage_students.php' class='button is-link'>Вернуться к списку студентов</a>";
        exit();
    } else {
...
<body>
    <div class="container">
        <h1 class="title has-text-centered mt-5">Редактировать студента</h1>

        <form action="edit_student.php?id=<?= $id ?>" method="POST" enctype="multipart/form-data" class="box">
            <div class="field">
                <label class="label">Имя студента</label>
                <div class="control">
                    <input class="input" type="text" name="name" value="<?= htmlspecialchars($student['name']) ?>" required>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="control">
                    <input class="input" type="text" name="group" value="<?= htmlspecialchars($student['group_name']) ?>" required>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="control" id="achievementFields">
                    ...
                    foreach ($achievements as $achievement) {
                        echo '<input class="input mt-2" type="text" name="achievements[]" value="' . htmlspecialchars($achievement) . '">';
                    }
                    ?>
                </div>
            ...
            <div class="field">
                ...
                <div class="control">
                    ...
                    <p class="help">Если вы не загрузите новое изображение, останется текущее.</p>
